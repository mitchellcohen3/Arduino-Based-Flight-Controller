...
unsigned long pulse_time_FM_prev;
...
//Remember some variables for the next iteration of the loop
    desired_yaw_previous = desired_yaw_deg;
    pulse_time_FM_prev = pulse_time_FM;
}
...
double get_desired_pitch(){
    ...
    return desired_pitch = lowpassFilter_tx_1.input(desired_pitch);
}
...
double get_desired_roll(){
    ...
    return desired_roll = lowpassFilter_tx_2.input(desired_roll);   
}
